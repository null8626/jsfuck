...
/// # Arguments
///
/// * `input` - The string slice to obfuscate.
///
/// # Examples
/// 
/// ```rust,no_run
...
/// Wraps the code with a pre-jsfucked `eval()` call.
/// Evaluating this should execute the code from the input.
///
/// # Arguments
///
/// * `input` - A reference to a mutable string returned from `jsfuck::obfuscate`.
///
/// # Examples
/// 
/// ```rust,no_run
